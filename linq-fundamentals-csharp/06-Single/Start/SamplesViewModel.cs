...
namespace LINQSamples
{
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public Product LastQuery()
    {
      ...
      // Test the exception handling
      value = (from prod in products select prod).Last(prod => prod.Color == "Purple");
    ...
    public Product SingleOrDefaultQuery()
    {
     ...
     // value = (from prod in products select prod).SingleOrDefault(prod => prod.ProductID == 706);
      ...
      value = (from prod in products select prod).SingleOrDefault(prod => prod.ProductID == 706,new Product { ProductID = -1, Name = "NOT FOUND" });
